...
<div class="container">
            <form class="form-horizontal" action="Admintaoquyen" role="form" method="POST" enctype="multipart/form-data" id="formsubmit">
                <h2>Thêm Quyền</h2>
                ...
                <div class="form-group">
                    <div class="col-sm-9">
                        ...
                        <div class="row mt-3">
                            <?php foreach($data['listctq1'] as $row) { ?>
                ...
                <div class="col-sm-9">
                <button type="submit" id="submitphim" name="submit" class=" submitphim btn btn-primary btn-block mt-5 ">Thêm</button>
                </div>
            </form> <!-- /form -->
        </div> <!-- ./container -->
